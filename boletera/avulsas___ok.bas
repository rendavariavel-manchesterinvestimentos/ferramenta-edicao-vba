...
'
    ...
    Next
proximaparte:
    ' Sobe dois n�veis para a raiz do operacional
    ChDir ".."
    endesave2 = CurDir
    ChDir ".."
    endesave = CurDir
    ...
    salvarBoleta = endesave & "\0 - A��ES\2 - BASKETS\"
    ...
    arqnome = "(A��ES) " & Year(Date) & " " & Format(Month(Date), "00") & " " & Format(Day(Date), "00") & " " & nome & " " & boletera.Range("C4").Value & " " & boletera.Range("F5") & " " & broker
